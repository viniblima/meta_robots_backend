...
class Robot(models.Model):
    ...
    energy = models.FloatField(_('Energia'), editable=False, )
    ...
    color_energy = models.CharField(_('Cor da Barra de Energia'), blank=False,
                                    null=False, choices=ENERGY_BAR_COLOR_OPTIONS,)
    class_robot = models.CharField(_('Classe'), blank=False,
                                   null=False, choices=CLASS_ROBOT_OPTIONS,)
    color_robot = models.CharField(_('Cor do robô'), blank=False,
                                   null=False, choices=COLOR_ROBOT_OPTIONS)
    ...
    team = models.ForeignKey(
        _('Time'), on_delete=models.SET_NULL, null=True, blank=True)
